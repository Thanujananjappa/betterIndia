...
export const communityService = {
  ...
  createUpdate: async (message: string) => {
  ...
  getCameraRequests: async () => cameraRequests,

  addCameraRequest: async (location: string, reason: string) => {
    const newRequest = {
  ...
  updateCameraRequestStatus: async (id: string, status: string) => {
  ...
  createCampaign: async (title: string, description: string) => {
    const newCampaign = {
